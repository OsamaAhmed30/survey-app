      ...
      <fieldset className="mb-4">
        ...
        <div className="mt-3">
          {question.type === "select" && (
            ...
            <div>
              {question.type == 'radio' &&question.data.options.map((option, ind) => (
          ...
          {question.type === "text" && (
            <div>
              <input
                type="text"
                onChange={(ev) => answerChanged(ev.target.value)}
                className="mt-1 block w-full rounded-md border-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-900 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          )}
